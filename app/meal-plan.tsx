...
function ShoppingList({ items, total }: { items: ShoppingItem[]; total: number }) {
  return <View style={s.shoppingCard}>
    ...
    <Text style={s.shoppingHint}>Quantità aggregate per tutte le 14 ricette</Text>
...
export default function MealPlanScreen() {
  ...
  return <Screen green>
    <View style={s.page}>
      ...
      <ShoppingList items={shopping.items} total={shopping.total} />
    </View>
  </Screen>;
}
